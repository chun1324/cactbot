  ...
  constructor(options, element) {
    ...
    this.regex = {
      ...
      cn: {
        ...
        cast: NetRegexes.gameLog({
          code: '08c3',
          line: '(?:[\\w\\s-\'\u4e00-\u9fa5·]+)在(?<place>.+)甩出了魚線開始釣魚。.*?',
        }),
        bite: NetRegexes.gameLog({ code: '08c3', line: '有魚上鉤了！.*?' }),
        catch: NetRegexes.gameLog({
          code: '0843',
          line:
            '(?:[\\w\\s-\'\u4e00-\u9fa5·]+)?成功釣上了.*?(?<fish>[\\d\\-\u3000-\u30ff\u3400-\u4dbf\u4e00-\u9faf·？]+\\d*).*（\\d+\\.\\d星寸）。.*?',
        }),
        nocatch: NetRegexes.gameLog({
          code: '08c3',
          line:
            '(?:[\\w\\s-\'\u4e00-\u9fa5·]+)?(?:不經意間魚餌被吃掉了……|不經意間丟掉了.+……|不經意間.+不見了……|不經意間魚餌被吃掉了……|上鉤的魚逃走了……|魚線斷了！|沒有釣到任何東西……\n\n現在使用的魚餌可能不太適合這片釣場。|沒有釣到任何東西……|.+收竿停止了釣魚。|魚帶著.+逃走了……|這裡的魚現在警惕性很高，看來還是換個地點比較好。|無法持有更多的.+，(?:[\\w\\s-\'\u4e00-\u9fa5·]+)?將剛釣上的東西放生了。).*?',
        }),
        mooch: NetRegexes.gameLog({
          code: '08c3',
          line:
            '(?:[\\w\\s-\'\u4e00-\u9fa5·]+)開始利用上鉤的.*?([\\d\\-\u3000-\u30ff\u3400-\u4dbf\u4e00-\u9faf·？]+\\d*).*嘗試以小釣大。.*?',
        }),
        quit: NetRegexes.gameLog({
          code: '08c3',
          line:
            '(?:[\\w\\s-\'\u4e00-\u9fa5·]+)?(?:收回了魚線。|陷入了戰鬥不能狀態，釣魚中斷。|收回了魚線。|受到了敵人的攻擊，釣魚中斷。).*?',
        }),
        discovered: NetRegexes.gameLog({
          code: '08c3',
          line: '將新釣場“(?<place>.+)”記錄到了釣魚筆記中！.*?',
        }),
      },
      ko: {
