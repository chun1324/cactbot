...
const bossFightTriggers: readonly Boss[] = [
  {
    ...
    startRegex: {
      ...
      cn: NetRegexes.gameLog({ line: '.*恭敬地對木人行禮.*?' }),
  ...
  },
  {
    ...
    startRegex: {
      ...
      cn: NetRegexes.startsUsing({ source: '凱夫卡', id: '28C2' }),
  ...
  },
  {
    ...
    startRegex: {
      ...
      cn: NetRegexes.startsUsing({ source: '凱夫卡', id: '28EC' }),
  ...
  },
  {
    ...
    startRegex: {
      ...
      cn: NetRegexes.ability({ source: '歐米茄M', id: '337D' }),
  ...
  },
  {
    ...
    startRegex: {
      ...
      cn: NetRegexes.ability({ source: '歐米茄', id: '336C' }),
