  ...
  options: [
    ...
    },
    {
      ...
      comment: {
        ...
        cn: `在觸發器輸出中指定玩家的預設方式。預設選項為輸出暱稱/名字。
             使用此選項可將輸出方式更改為玩家的職能名或職業名。
             若你不在小隊中或玩家離開小隊 (或出現錯誤時), 將預設輸出玩家暱稱。
             (注：國服對於暱稱和全名不做區分)`,
