  ...
  timelineReplace: [
    ...
    },
    {
      ...
      'replaceText': {
        ...
        'Demi-Aries': '亞靈白羊座',
        'Demi-Leo': '亞靈獅子座',
        'Demi-Virgo Feet': '亞靈室女座 腳',
        'Demi-Virgo Line(?!\/)': '亞靈室女座 直線',
        'Demi-Virgo Line/Tether': '亞靈室女座 直線/連線',
        'Demi-Virgo Tether(?!\/)': '亞靈室女座 連線',
        'Demi-Virgo Tether/Feet': '亞靈室女座 連線/腳',
        'Divine Light': '幻光波',
        'Divine Ruination': '聖光爆裂破',
        'Duskblade': '暗影之劍',
        'Earth Hammer': '大地之錘',
