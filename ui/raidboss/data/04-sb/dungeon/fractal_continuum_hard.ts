  ...
  timelineReplace: [
    ...
    },
    {
      ...
      'replaceSync': {
        ...
        'This humanoid prototype can perfectly replicate': '我們研究出瞭如何利用鬥神力量的方法！',
        'Utilizing our data on Sophia': '利用鬥神的力量去征服鬥神！',
        'Vocal Guidance System': '語音嚮導',
        'Servomechanical Minotaur': '自控化彌諾陶洛斯',
        'Servomechanical Chimera': '自控化奇美拉',
        'Proto-Chimera': '原型奇美拉',
        'Biomanufactured Minotaur': '生化彌諾陶洛斯',
      },
      'replaceText': {
        'Aether Bend': '乙太曲折',
