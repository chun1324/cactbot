...
const triggerSet: TriggerSet<Data> = {
  id: 'TheGhimlytDark64',
  zoneId: ZoneId.TheGhimlytDark64,
  timelineFile: 'ghimlyt_dark64.txt',
  timelineTriggers: [
    {
      id: 'Ghimlyt64 Prometheus Laser',
      regex: /Heat/,
      beforeSeconds: 5,
