...
const triggerSet: TriggerSet<Data> = {
  ...
  timelineFile: 'bardams_mettle63.txt',
  timelineTriggers: [
    {
      id: 'Bardam63 Feathercut',
      regex: /Feathercut/,
      beforeSeconds: 4,
  ...
  triggers: [
    ...
    {
      id: 'Bardam63 Wind Unbound',
      type: 'StartsUsing',
      netRegex: { id: '1F0A', source: 'Yol', capture: false },
      response: Responses.aoe(),
    },
    {
      id: 'Bardam63 Flutterfall',
      type: 'HeadMarker',
      netRegex: { id: '0017' },
    ...
    {
      id: 'Bardam63 Eye Of The Fierce',
      type: 'StartsUsing',
      netRegex: { id: '1F0D', source: 'Yol', capture: false },
      response: Responses.lookAway(),
    },
    {
      id: 'Bardam63 Wingbeat You',
      type: 'HeadMarker',
      netRegex: { id: '0010' },
      condition: Conditions.targetIsYou(),
      alertText: (_data, _matches, output) => output.text!(),
