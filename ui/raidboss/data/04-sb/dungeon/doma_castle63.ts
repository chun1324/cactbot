...
const triggerSet: TriggerSet<Data> = {
  ...
  timelineFile: 'doma_castle63.txt',
  triggers: [
    {
      id: 'DomaCastle63 Magitek Hexadrone 2-Tonze Magitek Missile',
      type: 'HeadMarker',
      netRegex: { id: '003E' },
      response: Responses.stackMarkerOn(),
    },
    {
      id: 'DomaCastle63 Magitek Hexadrone Magitek Missiles',
      type: 'StartsUsing',
    ...
    {
      id: 'DomaCastle63 Hypertuned Grynewaht Delay-Action Charge',
      type: 'HeadMarker',
      netRegex: { id: '0063' },
    ...
    {
      id: 'DomaCastle63 Hypertuned Grynewaht Thermobaric Charge',
      type: 'GainsEffect',
