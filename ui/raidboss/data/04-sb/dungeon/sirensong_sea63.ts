...
const triggerSet: TriggerSet<Data> = {
  id: 'TheSirensongSea63',
  zoneId: ZoneId.TheSirensongSea63,
  timelineFile: 'sirensong_sea63.txt',
  timelineTriggers: [
    {
      id: 'Sirensong63 Lorelei Head Butt',
      regex: /Head Butt/,
      beforeSeconds: 6,
  ...
  triggers: [
    {
      id: 'Sirensong63 Lugat Hydroball',
      type: 'HeadMarker',
      netRegex: { id: '003E' },
      response: Responses.stackMarkerOn(),
    },
    {
      id: 'Sirensong63 Lugat Sea Swallows All',
      type: 'StartsUsing',
      netRegex: { source: 'Lugat', id: '1F58', capture: false },
      response: Responses.drawIn(),
    },
    {
      id: 'Sirensong63 Lugat Overtow',
      type: 'StartsUsing',
      netRegex: { source: 'Lugat', id: '1F59', capture: false },
      response: Responses.knockback('info'),
    },
    {
      id: 'Sirensong63 Governor Shadowflow',
      type: 'StartsUsing',
    ...
    {
      id: 'Sirensong63 Governor Bloodburst',
      type: 'StartsUsing',
      netRegex: { source: 'The Governor', id: '1F5C', capture: false },
      response: Responses.aoe(),
    },
    {
      id: 'Sirensong63 Governor Enter Night',
      type: 'HeadMarker',
      netRegex: { id: '0016' },
    ...
    {
      id: 'Sirensong63 Fleshless Captive Seductive Scream',
      type: 'StartsUsing',
      netRegex: { source: 'Fleshless Captive', id: '2352' },
      response: Responses.stunOrInterruptIfPossible(),
    },
    {
      id: 'Sirensong63 Lorelei Morbid Advance',
      type: 'StartsUsing',
    ...
    {
      id: 'Sirensong63 Lorelei Morbid Retreat',
      type: 'StartsUsing',
    ...
    {
      id: 'Sirensong63 Lorelei Somber Melody',
      type: 'StartsUsing',
