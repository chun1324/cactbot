...
const triggerSet: TriggerSet<Data> = {
  ...
  timelineFile: 'the_burn64.txt',
  triggers: [
    {
      id: 'TheBurn64 Crystal Needle',
      type: 'StartsUsing',
      netRegex: { id: '3193', source: 'Hedetet' },
      response: Responses.tankBuster(),
    },
    {
      id: 'TheBurn64 Hailfire',
      type: 'HeadMarker',
    ...
    {
      id: 'TheBurn64 Crystal Shardfall',
      type: 'StartsUsing',
    ...
    },
    {
      ...
      id: 'TheBurn64 Crystal Dissonance',
      type: 'StartsUsing',
    ...
    {
      id: 'TheBurn64 Aetherochemical Flame',
      type: 'StartsUsing',
      netRegex: { id: '2D73', source: 'Defective Drone', capture: false },
      response: Responses.aoe(),
    },
    {
      id: 'TheBurn64 Aetherochemical Coil',
      type: 'StartsUsing',
      netRegex: { id: '2D72', source: 'Defective Drone' },
      response: Responses.tankBuster(),
    },
    {
      id: 'TheBurn64 Aetherochemical Residue',
      type: 'HeadMarker',
      netRegex: { id: '0002' },
