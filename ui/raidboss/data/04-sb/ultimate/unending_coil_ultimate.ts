  ...
  timelineReplace: [
    ...
    },
    {
      ...
      'replaceSync': {
        ...
        'Thunderwing': '雷翼',
        'Twintania': '雙塔尼亞',
        'From on high I descend, the hallowed moon to call': '我降臨於此，\\s*對月長嘯！',
        'From on high I descend, the iron path to walk': '我降臨於此，\\s*征戰鐵血霸道！',
        'Take fire, O hallowed moon': '熾熱燃燒！\\s*給予我月亮的祝福！',
        'Blazing path, lead me to iron rule': '被熾熱灼燒過的軌跡\\s*乃成鐵血霸道！',
        'O hallowed moon, take fire and scorch my foes': '月光啊！\\s*用你的熾熱燒盡敵人！',
        'O hallowed moon, shine you the iron path': '月光啊！\\s*照亮鐵血霸道！',
        'Fleeting light! \'Neath the red moon, scorch you the earth': '超新星啊，更加閃耀吧！\\s*照亮紅月下熾熱之地！',
        'Fleeting light! Amid a rain of stars, exalt you the red moon':
          '超新星啊，更加閃耀吧！\\s*在星降之夜，稱讚紅月！',
        'From on high I descend, the moon and stars to bring': '我降臨於此對月長嘯！\\s*召喚星降之夜！',
        'From hallowed moon I descend, a rain of stars to bring': '我自月而來降臨於此，\\s*召喚星降之夜！',
        'From hallowed moon I bare iron, in my descent to wield': '我自月而來攜鋼鐵降臨於此！',
        'From hallowed moon I descend, upon burning earth to tread': '我自月而來降臨於此，\\s*踏過熾熱之地！',
        'Unbending iron, take fire and descend': '鋼鐵燃燒吧！\\s*成為我降臨於此的刀劍吧！',
        'Unbending iron, descend with fiery edge': '鋼鐵成為我降臨於此的燃燒之劍！',
      },
      'replaceText': {
        '--push--': '--開怪--',
        ...
        '(?<! )Marker(?!\\w)': '標記',
        'Megaflare(?! Dive)': '百萬核爆',
        'Megaflare Dive': '百萬核爆衝',
        'Meteor Stream': '隕石流',
        'Meteor/Dive or Dive/Beam': '隕石/衝 或 衝/光束',
        'Morn Afah': '無盡頓悟',
        'Nael Marker': '奈爾標記',
        'Pepperoni': '大圈',
        'Plummet(?!\/)': '垂直下落',
