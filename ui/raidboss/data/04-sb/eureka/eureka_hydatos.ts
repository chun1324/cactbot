  ...
  timelineReplace: [
    ...
    },
    {
      ...
      'replaceSync': {
        ...
        '(?<! )Ozma(?!\\w)': '奧茲瑪',
        'Ozmashade': '奧茲瑪之影',
        'Proto Ozma(?! Containment)': '奧茲瑪原型',
        'Raiden': '萊丁',
        'Relative Virtue(?! gains)': '相對的美德',
        'Shadow': '奧茲瑪原型之影',
        'Streak Lightning': '強襲雷光',
        '5 minutes have elapsed since your last activity.': '已經5分鐘沒有進行任何操作',
        'The memories of heroes past live on again': '發動了英傑的加護的效果，重新甦醒了過來',
        'Munderg, turn flesh to ash': '紅頸妖槍，點燃一切！',
        'Munderg, turn blood to ice': '紅頸妖槍，凍結萬物！',
        'The Lance of Virtue Containment Unit': '美德之槍封印區',
        'The Shin-Zantetsuken Containment Unit': '真·斬鐵劍封印區',
        'The Proto Ozma Containment Unit': '奧茲瑪原型封印區',
