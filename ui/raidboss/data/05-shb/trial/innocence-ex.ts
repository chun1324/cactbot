  ...
  timelineReplace: [
    ...
    },
    {
      ...
      'replaceSync': {
        ...
        'Forgiven Venery': '得到寬恕的情慾',
      },
      'replaceText': {
        'Winged Rep Trident': '扇形斷罪飛翔',
        'Winged Rep Rotate': '風車斷罪飛翔',
        'Winged Rep Tethers': '連線斷罪飛翔',
        'Starbirth Corner': '創星角落',
        'Starbirth Avoid': '創星躲避',
        'Starbirth Charge': '創星突進',
        'Starbirth Explode': '創星爆炸',
        'Starbirth Final': '創星狂暴',
        'Soul And Body': '身心',
        'Shadowreaver': '奪影',
        'Scold\'s Bridle': '毒舌鉤',
