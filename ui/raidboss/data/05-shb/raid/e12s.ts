      ...
      response: (data, _matches, output) => {
        ...
        output.responseOutputStrings = {
          ...
          spread: {
            ...
            cn: '分散點名 (w/${player1}, ${player2}, ${player3})', // FIXME
  ...
  timelineReplace: [
    ...
    },
    {
      ...
      'replaceText': {
        ...
        'Dark Current': '黑暗奔流',
        '(?<! )Dark Eruption(?! )': '暗炎噴發',
        'Dark Eruption / Dark Water III': '暗炎噴發/黑暗狂水',
        'Dark Fire III': '黑暗爆炎',
        'Dark Water III / Dark Eruption': '黑暗狂水/暗炎噴發',
        '(?<! )Dark Water III(?! )': '黑暗狂水',
        'Darkest Dance': '暗夜舞蹈',
        'Diamond Dust': '鑽石星塵',
