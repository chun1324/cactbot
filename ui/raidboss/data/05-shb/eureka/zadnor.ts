...
const triggerSet: TriggerSet<Data> = {
  ...
  comments: {
    ...
    cn: '旗艦達爾裡阿達號攻略戰觸發器/時間軸。部分CE (緊急遭遇戰)。',
  ...
  timelineReplace: [
    ...
    },
    {
      ...
      'replaceText': {
        ...
        'Reverse Time Eruption': '時空地火噴發·逆轉',
        'Right Brand': '右印',
        'Ruinous Pseudomen': '魔科學式破滅預兆',
        'Sanctified Quake III': '聖化爆震',
        'South Wind': '南風',
        'Spiral Scourge': '螺旋災變',
        'Stormborne Zirnitra': '火焰札尼爾查妖蛇',
        'Stormcall': '呼喚風暴',
