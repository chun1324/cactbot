  ...
  timelineReplace: [
    ...
    },
    {
      ...
      'replaceText': {
        ...
        'Operation: Access Self-Consciousness Data': '通訊：21O自我數據',
        'Operation: Activate Laser Turret': '通訊：雷射砲塔',
        'Operation: Activate Suppressive Unit': '通訊：環狀槍擊裝置',
        'Operation: Pod Program': '通訊：輔助機程序',
        'Operation: Synthesize Compound': '通訊：爆炸性化合物',
        'Prime Blade': '斬機擊：填充',
        'R010: Laser': 'R010:雷射',
        'R011: Laser': 'R011：雷射',
        'R012: Laser': 'R012：雷射',
