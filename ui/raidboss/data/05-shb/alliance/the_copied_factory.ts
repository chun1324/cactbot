  ...
  timelineReplace: [
    ...
    },
    {
      ...
      'replaceSync': {
        ...
        'Warehouse B': '倉庫B',
        'Warehouse C': '倉庫C',
        'The wall-mounted right arm begins to move': '牆面的右臂開始運作……',
        'The wall-mounted flamethrowers activate\.': '牆面的火炎放射器開始運作……',
        'The wall-mounted left arm begins to move': '牆面的左臂開始運作……',
        'You hear frenzied movement from machines beneath': '地板下的機械生物動作很可疑……',
        'The conveyer belts whirr to life!': '地面上的滾軸開始運作……',
        'Flammable oil is leaking from the floor': '地板下開始充滿可燃性液體……',
      },
      'replaceText': {
        ...
        'Wide-Angle Diffuse Laser': '廣角擴散射線',
        '(?<! )Diffuse Laser': '擴散射線',
        ...
        'Ground-To-Ground Missile': '地對地導彈',
