  ...
  config: [
    {
      ...
      comment: {
        ...
        cn: `在 離子簇 機制中處理 debuff 的策略。

             無: 只播報 Debuff, 不使用策略。
             DN: 使用基於 shabin pastebin 的固定站位。`,
      },
      type: 'select',
      options: {
        en: {
