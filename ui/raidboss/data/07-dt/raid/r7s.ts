    ...
    },
    {
      ...
      outputStrings: {
        ...
        avoidBuster: {
          ...
          cn: '${stoneringer} => 小隊 ${inOut}, 遠離坦克死刑',
  ...
  timelineReplace: [
    ...
    },
    {
      ...
      'replaceText': {
        ...
        'Neo Bombarian Special': '新式超豪華野蠻大亂擊',
        'Pollen': '花粉',
        'Powerslam': '強震衝',
        'Pulp Smash': '荊棘揮打',
        'Quarry Swamp': '石化波動',
        ...
        'Sporesplosion': '孢子云',
        'Stoneringer(?![s ])': '石制武器',
        'Stoneringer 2: Stoneringers': '雙持石制武器',
        'Strange Seeds': '種彈炸裂',
