...
const triggerSet: TriggerSet<Data> = {
  ...
  timelineReplace: [
    ...
    },
    {
      'locale': 'cn',
      'replaceSync': {
        'Cloud Of Darkness': '暗黑之雲',
        'Cloud of Darkness': '暗黑之雲',
        'Cloudlet of Darkness': '暗黑之破片雲',
        'Stygian Shadow': '生於黑暗之物',
      },
      'replaceText': {
        '--adds untargetable--': '--小怪不可選中--',
        'Active-pivot Particle Beam': '迴旋式波動炮',
        '(?<!En)Aero IV': '飆風',
        'Blade of Darkness': '暗之刃',
        'Break IV': '超石化',
        'Chaos-condensed Particle Beam': '凝聚式波動炮',
        'Core-lateral Phaser': '正側跳躍波動炮',
        'Curse of Darkness': '波動詛咒',
        'Dark Dominion': '深暗領域',
        'Dark-energy Particle Beam': '詛咒式波動炮',
        '(?<!En)Death IV': '極死',
        'Deluge of Darkness': '暗之大氾濫',
        'Diffusive-force Particle Beam': '分散式波動炮',
        'Enaero IV': '超附風',
        'Endeath IV': '超附死',
        'Evaporation': '雲散',
        'Evil Seed': '種子彈',
        'Excruciate': '磔殺',
        'Feint Particle Beam': '潛地式波動炮',
        'Flare': '核爆',
        'Flood of Darkness': '暗之氾濫',
        'Ghastly Gloom': '恐懼之雲',
        'Grim Embrace': '陰冷擁抱',
        'Lateral-core Phaser': '側正跳躍波動炮',
        'Looming Chaos': '混沌迫近',
        '(?<! )Particle Beam': '波動爆炸',
        'Particle Concentration': '波動球',
        '(?<! )Phaser': '跳躍波動炮',
        'Rapid-sequence Particle Beam': '連射式波動炮',
        'Razing-volley Particle Beam': '齊射式波動炮',
        'Thorny Vine': '荊棘叢生',
