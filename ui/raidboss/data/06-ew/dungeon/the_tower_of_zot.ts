...
const triggerSet: TriggerSet<Data> = {
  ...
  timelineReplace: [
    ...
    },
    {
      ...
      'replaceText': {
        'Cinduruva': '馬格',
        'Delayed Element III': '延遲元素',
        'Delayed Thunder III': '延遲暴雷',
        'Delta Attack': '三角攻擊',
        ...
        'Manusya Bio(?! )': '人趣毒菌',
        'Manusya Bio III': '人趣劇毒菌',
        'Manusya Blizzard(?! )': '人趣冰結',
        ...
        'Sanduruva': '多格',
        'Sphere Shatter': '碎裂',
        'Transmute Element III': '魔力操縱：元素',
        'Transmute Thunder III': '魔力操縱：暴雷',
      },
    },
    {
      'locale': 'ko',
