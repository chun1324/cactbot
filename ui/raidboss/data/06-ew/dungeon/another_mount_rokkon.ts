  ...
  config: [
    {
      ...
      comment: {
        ...
        cn: `對於所有雙人分攤，該選項指定了選擇誰與誰分攤的優先級。
           如果你想讓近戰和坦克分攤 (假設分攤沒有同時點這兩個人), 選擇含有“近戰 (melee)”的選項。
           近戰 (melee) 分攤指的是 近戰+坦克 和 治療+遠程。職能分攤指的是 坦克 + 治療 和 DPS + DPS。
           搭檔分攤指的是 支援 + DPS 和 支援 + DPS (任何組合都有可能，支援位是坦克和治療)。
           如果隊伍中有兩名遠程 DPS 或近戰 DPS, 無論此配置選項如何, 它都不會報“近戰 (melees)”。
           沒有考慮對非標準陣容隊伍 (非 2 支援 + 2DPS) 構成的支持。`,
  ...
  triggers: [
    ...
    },
    {
      ...
      comment: {
        ...
        cn: `全異色 指的是所有人的 3 個 buff 中有 2 個同色 buff (2 個是一種顏色, 剩下 1 個是另一種)。
             半異色 指的是 2 個人有 2 個同色buff, 其餘 2 人擁有 3 個同色buff。`,
  ...
  timelineReplace: [
    ...
    },
    {
      ...
      'replaceText': {
        ...
        'Stygian Aura': '黑妖彈',
        '(?<!Eye of the )Thunder Vortex': '迴環渦雷',
        'Thundercall': '招雷',
        'Torching Torment': '煩熱',
