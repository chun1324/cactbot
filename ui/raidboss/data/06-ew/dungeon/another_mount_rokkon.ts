  ...
  config: [
    {
      ...
      comment: {
        ...
        cn: `對於所有雙人集合，該選項指定了選擇誰與誰集合的優先級。
           如果你想讓近戰優先和坦克集合, 選擇含有“近戰”的選項。
           近戰集合指的是 近戰+坦克 和 治療+遠程。職能集合指的是 坦克 + 治療 和 DPS + DPS。
           搭檔集合指的是 坦克 + DPS 和 治療 + DPS (任意組合均可)。
           如果隊伍中有兩名遠程 DPS 或近戰 DPS, 無論此配置選項如何, 它都不會報“近戰集合”。
  ...
  triggers: [
    ...
    },
    {
      ...
      comment: {
        ...
        cn: `“全異色” 指的是所有人的 3 個 buff 都有 2 種顏色 (2 個是一種顏色, 剩下 1 個是另一種)。
