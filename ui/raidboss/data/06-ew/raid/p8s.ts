      ...
      response: (data, _matches, output) => {
        ...
        output.responseOutputStrings = {
          ...
          noDebuff: {
            ...
            cn: '無Debuff (+ ${player1}, ${player2}, ${player3})',
      ...
      response: (data, _matches, output) => {
        ...
        output.responseOutputStrings = {
          ...
          colorTowerMergePlayers: {
            ...
            cn: '${color} 塔 (與${player1} 或 ${player2})',
    ...
    },
    {
      ...
      outputStrings: {
        multiple: {
          ...
          cn: '第二輪塔 (+ ${player1}, ${player2}, ${player3})',
    ...
    },
    {
      ...
      outputStrings: {
        multiple: {
          ...
          cn: '第一輪塔 (+ ${player1}, ${player2}, ${player3})',
  ...
  timelineReplace: [
    ...
    },
    {
      ...
      'replaceText': {
        ...
        'Ego Death': '自我概念崩壞',
        'Ektothermos': '爆熱波動',
        'Emergent Diflare': '二分核爆之現',
        'Emergent Octaflare': '八分核爆之現',
        'Emergent Tetraflare': '四分核爆之現',
        'End of Days': '米吉多烈焰',
        'Everburn': '創造不死鳥',
        'Eye of the Gorgon': '戈爾貢石眼',
        '(?<!Nest of )Flameviper': '炎蛇炮',
        'Footprint': '踐踏',
        'Forcible Difreeze': '強制二分玄冰',
        'Forcible Fire II(?!I)': '強制烈炎',
        'Forcible Fire III': '強制爆炎',
        'Forcible Trifire': '強制三分火炎',
