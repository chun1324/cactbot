...
const localeLines = {
  countdownStart: {
    ...
    cn: '距離戰鬥開始還有(?<time>\\y{Float})秒！ （(?<player>.*?)）',
  ...
  areaSeal: {
    ...
    cn: '距(?<area>.*?)被封鎖還有(?<time>\\y{Float})秒',
  ...
  craftingStart: {
    ...
    cn: '(?<player>\\y{Name})開始製作“\ue0bb(?<recipe>.*)”(×(?<count>\\d+))?。',
  ...
  trialCraftingStart: {
    ...
    cn: '(?<player>\\y{Name})開始練習製作\ue0bb(?<recipe>.*)。',
  ...
  craftingFinish: {
    ...
    cn: '(?<player>\\y{Name})製作“\ue0bb(?<recipe>.*)(\ue03c)?”(×(?<count>\\d+))?成功！',
  ...
  trialCraftingFinish: {
    ...
    cn: '(?<player>\\y{Name})練習製作\ue0bb(?<recipe>.*)成功了！',
  ...
  trialCraftingFail: {
    ...
    cn: '(?<player>\\y{Name})練習製作\ue0bb(?<recipe>.*)失敗了……',
